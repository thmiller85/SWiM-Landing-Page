...
export const createPostSchema = z.object({
  ...
  slug: z.string().min(1),
  content: z.string(),
  metaTitle: z.string().optional().transform(val => val || undefined),
  metaDescription: z.string().optional().transform(val => val || undefined),
  canonicalUrl: z.string().optional().transform(val => val || undefined),
  excerpt: z.string().optional().transform(val => val || undefined),
  featuredImage: z.string().nullable().optional().transform(val => val || null),
  featuredImageAlt: z.string().optional().transform(val => val || undefined),
